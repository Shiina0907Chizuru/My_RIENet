...
def main():
    ...
    if args.dataset == 'ca_point':
        ...
        if not args.eval:
            ...
            train_path = "/zhaoxuanj/Point_dataset/313_cryoalign_point_dataset/train_pkl_normalize"
        ...
        test_path = "/zhaoxuanj/Point_dataset/313_cryoalign_point_dataset/test_pkl_normalize"
